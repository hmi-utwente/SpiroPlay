...
namespace Spirometry.Statics
{
    ...
    public class Validation
    {
        ...
        private static List<SpiroData> GetVolume(List<SpiroData> data)
        {
            float dt = 0.01f;
        ...
        private static float GetEV(List<SpiroData> expiration, float newTimeZero)
        {
            try
            {
                ...
                var interpExpir = new List<Vector2>();
        ...
        //criteria 2A: if the volume difference for the last second of expiration is high enough, return error
        ...
        //Criteria 2B: (END OF TEST) FET (forced expiratory time) is at least 3 seconds (should have been 3 according to Miller but is really hard!)
        ...
        //criteria 2c: premature ending / steep fall off at the end of the flow volume curve detection
